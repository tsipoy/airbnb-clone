...
function App() {
  ...
  const staysLs = stays.map((stay) => (
    <div key={stay.title}>
      <img src={stay.photo} alt={stay.title} />
      <ApartmentStyled>
        <button className="super-host">SuperHost</button>
        <p className="rooms">{stay.type}</p>
        <p className="rooms">{stay.beds} beds</p>
        <div className="rate">
          <span>
            <svg
  ...
  return (
    <div>
      <Header>
        ...
        <div onClick={openPopup} className="popup">
        ...
        {isOpened && (
          <form>
            ...
            <label>
              GUEST
              <input type="dropdown" name="guests" />
            </label>
        ...
        <MainContent>
          ...
          <div className="div-layout">{staysLs}</div>
        </MainContent>
      </Header>
    </div>
  );
